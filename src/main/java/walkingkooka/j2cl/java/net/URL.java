...
//        }
        ...
        try {
            ...
            URLStreamHandler.parseURL(this, spec, ++index, spec.length());
        } catch (Exception e) {
            throw new MalformedURLException(e.toString());
        }
...
//        }
    ...
    public boolean equals(Object o) {
        ...
        return URLStreamHandler.equals(this, (URL) o);
    }
    ...
    public boolean sameFile(URL otherURL) {
        ...
        return URLStreamHandler.sameFile(this, otherURL);
    }
...
//            hashCode = strmHandler.hashCode(this);
            hashCode = URLStreamHandler.hashCode(this);
        }
        return hashCode;
    }
...
//        return strmHandler.toExternalForm(this);
        return URLStreamHandler.toExternalForm(this);
    }
...
//    }
    ...
    public int getDefaultPort() {
        ...
        return URLStreamHandler.getDefaultPort();
    }
}
