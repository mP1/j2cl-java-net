...
//    }
     ...
     */
    /*protected*/
    static void parseURL(URL u, String str, int start, int end) {
        if (end < start || end < 0) {
...
//    }
     ...
     */
    /*protected*/
    static void setURL(URL u, String protocol, String host, int port,
...
//    }
    /*protected*/
    static boolean hostsEqual(URL url1, URL url2) {
     ...
     *         otherwise.
     */
    /*protected*/ static boolean sameFile(URL url1, URL url2) {
